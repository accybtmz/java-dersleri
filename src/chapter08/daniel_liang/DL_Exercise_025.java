 ...
 * public static boolean isMarkovMatrix(double[][] m) * * Write a test program
 * that prompts the user to enter a 3 * 3 matrix of double * values and tests
 * whether it is a Markov matrix. *
 *********************************************************************************/
public class DL_Exercise_025 {
	/** Main method */
	...
	/**
	 * isEachColumnSum1 returns true if the sum of the elements in each column is 1
	 */
