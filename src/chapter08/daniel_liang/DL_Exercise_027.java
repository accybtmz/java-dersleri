 ...
 * intact.* * public static double[][] sortColumns(double[][] m) * * Write a
 * test program that prompts the user to enter a 3 * 3 matrix of double * values
 * and displays a new column-sorted matrix. Here is a sample run: *
 *********************************************************************************/
public class DL_Exercise_027 {
	/** Main method */
	...
	/**
	 * getMatrix prompts the user to enter a 3 x 3 matrix of double values then
	 * returns it
	 */
	...
	/**
	 * sortColums return a new column-sorted array leaving original array intact
	 */
