...
public class DL_Exercise_014 {
	...
	/**
	 * allSubDiagonal returns 0 or 1 if all 0s or 1s on the sub-diagonal, otherwise
	 * returns -1
	 */
	...
	/**
	 * allMajorDiagonal returns 0 or 1 if all 0s or 1s on the major diagonal,
	 * otherwise returns -1
	 */
	...
	/**
	 * allColumn returns 0 or 1 if a column has all 0s or 1s, otherwise returns -1
	 */
	...
	/**
	 * allRow returns 0 or 1 if a row has all 0s or 1s, otherwise returns -1
	 */
	...
	/**
	 * getMatrix prompts the user to enter the length of a square matrix and
	 * randomly fills in 0s and 1s into the matrix, then returns it
	 */
