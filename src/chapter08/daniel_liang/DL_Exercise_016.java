 ...
 * using the following header: * * public static void sort(int m[][]) * * The
 * method performs a primary sort on rows and a secondary sort on iumns. * For
 * example, the following array * * {{4, 2},{1, 7},{4, 5},{1, 2},{1, 1},{4, 1}}
