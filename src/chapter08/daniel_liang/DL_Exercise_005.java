 ...
 * * the method is as follows: * * public static double[][] addMatrix(double[][]
 * a, double[][] b) * * In order to be added, the two matrices must have the
 * same dimensions and the * same or compatible types of elements. Let c be the
 * resulting matrix. Each * element cij is aij + bij. * Write a test program
 * that prompts the user to enter two 3 * 3 matrices and * displays their sum. *
 *********************************************************************************/
public class DL_Exercise_005 {
	/** Main method */
