...
public class DL_Exercise_036 {
	...
	/**
	 * isDistinctRow returns true if Latin letters, each occur exactly once in each
	 * row
	 */
	...
	/**
	 * isDistinctColumn returns true if Latin letters, each occur exactly once in
	 * each column
	 */
