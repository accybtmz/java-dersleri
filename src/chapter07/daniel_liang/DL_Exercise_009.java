 ...
 * * an array of double values using the following header: * public static
 * double min(double[] array) * Write a test program that prompts the user to
 * enter ten numbers, invokes this * method to return the minimum value, and
