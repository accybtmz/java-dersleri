 ...
 * identical, using the following header: * * public static boolean equals(int[]
 * list1, int[] list2) * * Write a test program that prompts the user to enter
 * two lists of integers and * displays whether the two are identical. Here are
 * the sample runs. Note that * the first number in the input indicates the
