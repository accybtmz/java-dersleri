 ...
 * * of integers. The method header is specified as follows: * public static int
 * gcd(int... numbers) * Write a test program that prompts the user to enter
 * five numbers, invokes the * method to find the gcd of these numbers, and
 * displays the gcd. *
 *********************************************************************************/
