 ...
 * linearSearch * method in Listing 7.6. Sort the array and estimate the
 * execution time of * invoking the binarySearch method in Listing 7.7. You can
 * use the following * code template to obtain the execution time: * long
 * startTime = System.currentTimeMillis(); * perform the task; * long endTime =
