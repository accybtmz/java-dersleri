 ...
 * * array with the following headers: * public static int average(int[] array)
 * * public static double average(double[] array) * Write a test program that
 * prompts the user to enter ten double values, invokes * this method, and
