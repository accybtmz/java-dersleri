 ...
 * if * list1 and list2 are strictly identical, using the following header: * *
 * public static boolean equals(int[] list1, int[] list2) * * Write a test
