 ...
 * * sorted in increasing order. * * public static boolean isSorted(int[] list)
...
public class DL_Exercise_019 {
	...
	/**
	 * isSorted returns true if the list is already sorted in increasing order.
	 * Otherwise false
	 */
