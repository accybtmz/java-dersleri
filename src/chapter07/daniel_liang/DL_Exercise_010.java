 ...
 * index * of the smallest element in an array of integers. If the number of
...
public class DL_Exercise_010 {
	...
	/**
	 * Method indexOfSmallestElement returns the index of the smallest element in an
	 * array of integers
	 */
